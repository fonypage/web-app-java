...
VALUES (
  'Практика: Переменные и типы данных',
  '<p>В этом упражнении вы закрепите навыки работы с переменными и типами данных в Java.</p>
   <p><strong>Задача:</strong> реализуйте метод <code>format()</code>, который возвращает строки с переменными базовых типов.</p>',
  'practice',
  NULL
);
...
VALUES (
  @topic_id,
  'Переменные: форматированный вывод',
  '<p>Реализуйте метод <code>format()</code>, который возвращает текст:</p>
   <pre><code>byte: 100
short: 20000
int: 123456
long: 123456789
